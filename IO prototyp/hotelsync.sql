...
--
-- Host: 127.0.0.1
-- Czas generowania: 08 Cze 2025, 14:40
...
(1, 'Zupa pomidorowa', '12.50', 1),
(2, 'Schabowy z ziemniakami', '25.00', 1),
(3, 'Sałatka grecka', '18.00', 1),
(4, 'Pizza Margherita', '30.00', 1),
(5, 'Pieczona Mewa', '21.37', 1);
...
INSERT INTO `pokoj` (`id_pokoj`, `numer`, `typ`, `status`, `maks_ilosc_gosci`) VALUES
(1, '101', 'dungeon', 'zajety', 2),
(2, '102', 'lapis lazuli', 'zajety', 3),
(3, '103', 'ocean', 'zajety', 2),
(4, '105', 'premium', 'serwis', 6),
(7, '104', 'dungeon', 'zajety', 2);
...
(7, 'Andrzej', 'Wiertarara', 'gosc', 'wiertara@maczuga.pl', '', '+48123456789'),
...
--
ALTER TABLE `pokoj`
  MODIFY `id_pokoj` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
